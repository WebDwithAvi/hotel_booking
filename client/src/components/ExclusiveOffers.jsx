  ...
  return (
    <div className='flex flex-col items-center px-6 md:px-16 lg:px-24 xl:px-32 pt-20 pb-30'>
        <div className='flex flex-col md:flex-row items-center justify-between w-full'>
            <Title align={"left"} title={"Exclusive Offeres"} subTitle={"         Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolor inventore dolorem praesentium voluptate culpa id corrupti iste assumenda voluptatum odio."}/>
   
            <button className='group flex items-center gap-2 font-medium cursor-pointer max-md:mt-12'>Show All <img src={assets.arrowIcon} alt="arrow-icon" /></button>
        </div>
