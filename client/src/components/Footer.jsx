  ...
  return (
    ...
    <div className='flex flex-wrap justify-between gap-12 md:gap-6'>
        <div className='max-w-80'>
            <img  src={assets.logo} alt="logo" className='mb-4 h-8 md:h-9 invert-100 ' />
            <p className='text-sm'>
            ...
            <div className='flex items-center gap-3 mt-4'>
               ...
               <img className='w-6' src={assets.twitterIcon} alt="insta-icon" />
        ...
        <div>
            <p className=' font-playfair text-lg text-gray-800'></p>
